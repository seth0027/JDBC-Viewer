 ...
 * 
 * This is used specifically for cases when lambda needs to throw a checked exception.
 * Default java.util.funtion which are <Code>@FunctionalInterface</Code>s don't support throwing checked exceptions.
 * 
